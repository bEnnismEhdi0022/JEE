...
public class PatientsMvcApplication {
	...
	CommandLineRunner saveUsers(SecurityService securityService){
		return args -> {
			securityService.saveNewUser("bennis","1234","1234");
			securityService.saveNewUser("mar","1234","1234");
			securityService.saveNewUser("tst","1234","1234");

			securityService.saveNewRole("USER","");
			securityService.saveNewRole("ADMIN","");

			securityService.addRoleToUser("bennis","USER");
			securityService.addRoleToUser("bennis","ADMIN");
			securityService.addRoleToUser("mar","USER");
			securityService.addRoleToUser("tst","USER");
		};
	}
}
